...
df_cost <- bind_rows(list =
                   tibble(vcmax = seq(1, upper_end, length.out = df_ref$nsteps),
                   ...
                   tibble(vcmax = rep(df_ref$vcmax_start, df_ref$nsteps),
                          jmax  = seq(1, upper_end, length.out = df_ref$nsteps),
                          gs    = rep(df_ref$gs_start, df_ref$nsteps),
                          cost_var   = "jmax"),
                   tibble(vcmax = rep(df_ref$vcmax_start, df_ref$nsteps),
                          jmax  = rep(df_ref$jmax_start, df_ref$nsteps),
...
# ggsave("~/projects/mscthesis/docs/fig-facet-numerical-stability-pl-eb.pdf", p_starting_conditions_facet, height = 7, width = 7)
```
