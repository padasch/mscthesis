...
p_s37$plot[[3]] + ylim(0, 400) + theme(legend.position = "bottom") + xlab("")
```
...
p_f89$plot[[3]] + ylim(0, 200) + theme(legend.position = "bottom") + xlab("")
```
...
library(facetscales)
scales_x <- list(
  "vcmax_start" = scale_x_continuous(limits = c(0, 20), breaks = seq(0, 20, length.out = 5)),
  "jmax_start"  = scale_x_continuous(limits = c(0, 20), breaks = seq(0, 20, length.out = 5)),
  "gs_start"    = scale_x_continuous(limits = c(0, 1),  breaks = seq(0, 1, length.out = 5)))

scales_y <- list(
  "vcmax_opt" = scale_y_continuous(limits = c(0, 20), breaks = seq(0, 20, length.out = 5)),
  "jmax_opt"  = scale_y_continuous(limits = c(0, 20), breaks = seq(0, 20, length.out = 5)),
  "gs_opt"    = scale_y_continuous(limits = c(0, 0.5),  breaks = seq(0.1, 0.5,  length.out = 5)))
...
# ggsave("~/projects/mscthesis/temp/p_starting_conditions_facet_pl_eb.jpg", p_starting_conditions_facet, height = 6, width = 7)
```
