...
# ggsave("~/projects/mscthesis/docs/fig-comparison-analytic-vcmax.pdf", plot = p, height = 4.5, width = 8)
...
# ggsave("~/projects/mscthesis/docs/fig-comparison-numeric-vcmax.pdf", plot = p, height = 4.5, width = 8)
...
# ggsave("~/projects/mscthesis/docs/fig-comparison-numeric-jmax.pdf", plot = p, height = 4.5, width = 8)
```
...
ptitle <- "Effect of Energy Balance | Smith - Formulation" # DATEN VON OBEN HOLEN!
...
(p <- p2 / p1 + plot_annotation(title = ptitle))
