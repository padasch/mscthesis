...
## Plots
p1 <- p_ana_s37 + xlim(0, 4e-4) + ylim(0, 4e-4)
p2 <- p_num_s37 + xlim(0, 4e-4) + ylim(0, 4e-4)
...
## Plots
p1 <- p_ana_f89 + xlim(0, 4e-4) + ylim(0, 4e-4)
p2 <- p_num_f89 + xlim(0, 4e-4) + ylim(0, 4e-4)
...
### Does implementation of calc_jmax work?
...
## Plots
p1_s37 <- p_ana_s37 + xlim(0, 4e-4) + ylim(0, 4e-4)
p2_s37 <- p_num_s37 + xlim(0, 4e-4) + ylim(0, 4e-4)
...
```{r, fig.width=8, fig.height=2}
## Plots
p1_f89 <- p_ana_f89 + xlim(0, 6e-4) + ylim(0, 6e-4)
p2_f89 <- p_num_f89 + xlim(0, 6e-4) + ylim(0, 6e-4)
