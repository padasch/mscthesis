...
## Plots
# p1 <- p_noeb +  xlim(0, 250) + ylim(0, 250)
# p2 <- p_eb_pl + xlim(0, 250) + ylim(0, 250)
# p3 <- p_eb_te + xlim(0, 250) + ylim(0, 250)
# 
...
## Plots
p_all_30     + xlim(0, 250) + ylim(0, 250)
p_temp10     + xlim(0, 250) + ylim(0, 250)
p_ppfd10     + xlim(0, 250) + ylim(0, 250)
p_tempppfd30 + xlim(0, 250) + ylim(0, 250)
