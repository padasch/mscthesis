...
```{r}
## Setup for df_ref
df_ref <- get_df_ref(settings = get_settings())
...
for (n in 1:nrow(df_full)) {
    ...
    ## .................................................................................................
    ## New version with single optimization:
        if (df_full$setup[n] == "plantecophys") {
        ## 2.1: Via plantecophys energy balance
        df_full$tc_leaf[n] <- calc_tc_leaf_from_tc_air(tc_air    = df_full$tc_air[n],
                                                       gs        = df_full$gs_w[n],
                                                       vpd       = vpd,
                                                       patm      = patm,
                                                       ppfd      = ppfd)
        
    } else if (df_full$setup[n] == "tealeaves") {
        ...
        leaf_par <- make_leafpar(
            replace = list(
                g_sw = set_units(df_full$gs_w[n]*10^6, "umol/m^2/s/Pa")))
        
        # Get environmental parameters:
        enviro_par <- make_enviropar(
            replace = list(
                T_air = set_units(df_full$tc_air[n] + 273.15, "K"),
        ...
        # Get tc_leaf:
        df_full$tc_leaf[n] <- tleaf(leaf_par, enviro_par, constants, quiet = TRUE)$T_leaf %>% 
            set_units("degree_Celsius") %>% drop_units()
    }

    ## .................................................................................................
    ## Old version with double optimization:
